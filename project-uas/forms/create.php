...
<head>
    ...
    <div class="h-full px-3 py-8 overflow-y-auto bg-white border-r">
        <ul class="font-medium">
            ...
            <li>
                <a href="#" class="flex items-center p-5 text-white rounded-lg hover:bg-green-700 bg-green-600">
                <svg aria-hidden="true" class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-medium:text-slate-500" fill="white" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M8.707 7.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l2-2a1 1 0 00-1.414-1.414L11 7.586V3a1 1 0 10-2 0v4.586l-.293-.293z"></path><path d="M3 5a2 2 0 012-2h1a1 1 0 010 2H5v7h2l1 2h4l1-2h2V5h-1a1 1 0 110-2h1a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2V5z"></path></svg>
    ...
    <div class="py-12 px-24 sm:ml-64">
        <div class="w-full justify-between p-4 pb-12 mb-12 border-b">
            <div>
                <span class="text-4xl text-slate-700 font-regular">Tambah Data Mahasiswa</span>
            </div>
        </div>
        ...
        <form action="" method="post" class="p-4" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <input type="text" id="nrp" name="nrp" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
            </div>
            <div class="mb-6">
            ...
            <div class="mb-6 flex-row w-full gap-y-2">
                ...
                <div class="flex flex-column w-full gap-x-3">
                    <div class="flex items-center px-4 border border-gray-200 rounded">
                        <input checked id="jenis_kelamin_1" type="radio" value="Laki-Laki" name="jenis_kelamin" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500">
                        <label for="jenis_kelamin_1" class="w-full py-4 ml-2 text-sm font-medium text-gray-900">Laki-Laki</label>
                    </div>
                    <div class="flex items-center px-4 border border-gray-200 rounded">
                        <input id="jenis_kelamin_2" type="radio" value="Perempuan" name="jenis_kelamin" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500">
            ...
            <div class="mb-6">
                ...
                <div class="flex flex-column w-full gap-x-3">
                    <div class="flex items-center px-4 border border-gray-200 rounded">
                        <input checked id="kelas_1" type="radio" value="A" name="kelas" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500">
                        <label for="kelas_1" class="w-full py-4 ml-2 text-sm font-medium text-gray-900">A</label>
                    </div>
                    <div class="flex items-center px-4 border border-gray-200 rounded">
                        <input id="kelas_2" type="radio" value="B" name="kelas" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500">
